...
- `GET /` - List purchase orders (filters: status, third_party_id, company_id, contract_request_id, search, exclude_cancelled — used by the sidebar count; the list page shows cancelled ones in their own « Annulés » tab)
