...
DEFAULT_ARTICLES = [
    {
        ...
        "article_number": 1,
        "title": "OBJET",
        "content": "Le présent contrat a pour objet de définir les conditions dans lesquelles le PARTENAIRE participe à des travaux informatiques pour le compte de {{ issuer_company_name }}, auprès de la clientèle de {{ issuer_company_name }}.",
        "is_editable": False,
        "is_active": True,
    },
    {
        ...
        "content": "Le service consiste à mettre à la disposition du client de {{ issuer_company_name }} un collaborateur du PARTENAIRE afin de réaliser la prestation d'assistance technique définie en annexe au présent contrat.",
        "is_editable": False,
        "is_active": True,
    },
    {
