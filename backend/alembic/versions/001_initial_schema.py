...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["candidate_id"], ["candidates.id"], name="fk_cooptations_candidate"
        ),
        sa.ForeignKeyConstraint(
            ["opportunity_id"], ["opportunities.id"], name="fk_cooptations_opportunity"
        ),
    ...
    op.create_index(
        "ix_cooptations_opportunity_id", "cooptations", ["opportunity_id"], unique=False
    )
