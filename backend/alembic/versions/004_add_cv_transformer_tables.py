...
down_revision: Union[str, None] = '003_add_inv_boond_ids'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('template_id', UUID(as_uuid=True), sa.ForeignKey('cv_templates.id'), nullable=True),
    ...
    op.create_index('ix_cv_transformation_logs_created_at', 'cv_transformation_logs', ['created_at'])
