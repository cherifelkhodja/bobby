...
def upgrade() -> None:
    ...
    op.add_column(
        "cm_contract_requests", sa.Column("consultant_civility", sa.String(10), nullable=True)
    )
    op.add_column(
        "cm_contract_requests", sa.Column("consultant_first_name", sa.String(255), nullable=True)
    )
    op.add_column(
        "cm_contract_requests", sa.Column("consultant_last_name", sa.String(255), nullable=True)
    )

    # Mission address (replaces mission_location)
    op.add_column(
        "cm_contract_requests", sa.Column("mission_site_name", sa.String(255), nullable=True)
    )
    op.add_column(
        "cm_contract_requests", sa.Column("mission_address", sa.String(500), nullable=True)
    )
    op.add_column(
        "cm_contract_requests", sa.Column("mission_postal_code", sa.String(10), nullable=True)
    )
