...
class ThirdPartyRepository:
    ...
    async def save(self, third_party: ThirdParty) -> ThirdParty:
        ...
        if model:
            ...
            model.representative_first_name = third_party.representative_first_name
            model.representative_last_name = third_party.representative_last_name
            model.representative_email = third_party.representative_email
            model.representative_phone = third_party.representative_phone
            model.signatory_civility = third_party.signatory_civility
            model.signatory_first_name = third_party.signatory_first_name
            ...
            model.adv_contact_email = third_party.adv_contact_email
            model.adv_contact_phone = third_party.adv_contact_phone
            model.billing_contact_civility = third_party.billing_contact_civility
            model.billing_contact_first_name = third_party.billing_contact_first_name
    ...
    def _to_entity(self, model: ThirdPartyModel) -> ThirdParty:
        ...
        return ThirdParty(
            ...
            representative_first_name=model.representative_first_name,
            representative_last_name=model.representative_last_name,
            representative_email=model.representative_email,
            representative_phone=model.representative_phone,
            signatory_civility=model.signatory_civility,
            signatory_first_name=model.signatory_first_name,
            ...
            adv_contact_email=model.adv_contact_email,
            adv_contact_phone=model.adv_contact_phone,
            billing_contact_civility=model.billing_contact_civility,
            billing_contact_first_name=model.billing_contact_first_name,
    ...
    def _to_model(self, entity: ThirdParty) -> ThirdPartyModel:
        ...
        return ThirdPartyModel(
            ...
            representative_first_name=entity.representative_first_name,
            representative_last_name=entity.representative_last_name,
            representative_email=entity.representative_email,
            representative_phone=entity.representative_phone,
            signatory_civility=entity.signatory_civility,
            signatory_first_name=entity.signatory_first_name,
            ...
            adv_contact_email=entity.adv_contact_email,
            adv_contact_phone=entity.adv_contact_phone,
            billing_contact_civility=entity.billing_contact_civility,
