...
class TestCooptationStatusProperties:
    ...
    def test_is_pending_false_for_other_statuses(self):
        ...
        for status in [CooptationStatus.IN_REVIEW, CooptationStatus.INTERVIEW, 
                       CooptationStatus.ACCEPTED, CooptationStatus.REJECTED]:
    ...
    def test_is_final_false_for_non_final_statuses(self):
        ...
        for status in [CooptationStatus.PENDING, CooptationStatus.IN_REVIEW, 
